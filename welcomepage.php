...
?>
    ...
    <div style="min-height: 100%; min-height: 100vh; display: flex; align-items: center;">
        <div class="container align-items-center align-items-sm-center">
            <h1 class="arbaic-text-small-heading" style="color: #005cbf; font-size: large;">تم إنشاء الحساب بنجاح!</h1>
            <br>
            <h1 class="arbaic-text-title2" dir="rtl">أهلاً بك يا <strong style="color: #f5378e"><?php echo $userFirstname;?></strong></h1>
            <br>
            <h2 class="arbaic-text-small-heading" dir="rtl"><?php echo $usercode;?></h2>
            <br>
            <a href="index.php" class="btn btn-primary3 arbaic-text-small-heading" style="color: #633991; min-width: 100%;">الصفحة الرئيسية</a>
        </div>
    </div>
</div>
